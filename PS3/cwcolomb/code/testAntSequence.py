...
parser.add_argument('--tolerance', type=float, default=0.06, help='binary threshold of intensity difference when computing the mask')
...
def show_frame(f, save=False):
    ...
    if save:
        plt.axis('off')
        plt.savefig("../outputs/q2_3_ant_{}.png".format(f), bbox_inches = 'tight')
    else:
        plt.show()
